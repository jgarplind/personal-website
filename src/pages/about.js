...
const About = () => (
  <Layout>
    <SEO title="About Joel Garplind — Front-End Developer" />
    <main>
      <h1>About</h1>
      <h2>Intro</h2>
      <p>
      ...
      <ul>
        <li>
          <a
            ...
            href="icg.isy.liu.se/courses/tsit02/"
          >
            Computer security
          </a>
        </li>
        <li>
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://www.ida.liu.se/~TDDD23/index.en.shtml"
          >
            Game development
          </a>{" "}
          see a{" "}
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://www.youtube.com/watch?v=YwdE70dGcmw"
          >
            game trailer
          </a>
        </li>
      ...
      <p>
        ...
        play with, but most sports, e-sports, chess (is not a sport, right?),
        ...
        the (small) country to play tournaments.
      </p>
      <h2>
      ...
      <p>
        ...
        miniscule subset of the skills I and others possess. Still, they are
        verified merits, so here goes:
      </p>
      ...
      <p>
        ...
        working in agile environments, both from school projects (in particular
        one project-centered course:{" "}
        <a href="https://www.ida.liu.se/~TDDC88/index.en.shtml">
          Programvaruutveckling/PUMen
        </a>
        ) but increasingly from work experience on a daily basis since
        graduation. Agile to me is a mindset and a philosophy more so than a
        cadence based work schedule, and I am happy to discuss it. Final note: I
        do think that SAFe does bring up a lot of good points, but I don't think
      ...
      <p>Spanish – the language I learned in school but never applied.</p>
      <p>Korean – the language I briefly learned and try not to forget.</p>
      <h2>
        Personal{" "}
